...
<section id="about" class="s-about py-5">
    <div class="container">
        ...
        <div class="row about-me__buttons">
            ...
            <div class="col-lg-5 tab-full" data-aos="fade-up">
                <a href="Naveed_Malik_NUST.pdf" class="btn btn--primary w-100">Download CV</a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-md-6 work-item" data-aos="fade-up">
                <div class="work-item-content">
                    ...
                    <div class="text-center">
                        <img src="./images/mcpinsight-bg-login.png" style="width:50%" alt="Company Logo" class="company-logo">
                    </div>
                    ...
                    <div class="work-content">
                        <div class="work-header">
                            <p class="timeline__timeframe">March 2022 - Present</p>
                            <h5>National Emergency Operations Centre</h5>
...
<section class="s-testimonials">
  <div class="testimonials" data-aos="fade-up">
    <div class="testimonials__slider">
      <!-- Left Arrow -->
      <button class="arrow arrow--left" aria-label="Previous testimonial">&larr;</button>
      ...
      <div class="testimonials__slides">
        ...
        <!-- Testimonial Slides -->
          ...
          <p>
            “He is passionate about his work. Because he loves what he does, he
            has a steady source of motivation that drives him to do his best
            and learn new skills that help him to do better work.”
          </p>
          <div class="testimonials__info">
            ...
            <cite class="testimonials__cite">
              <strong>Muhammad Asaf Javed</strong>
              <span>Project Manager, NEOC</span>
            </cite>
          </div>
        </div>
        ...
        <div class="testimonials__slide">
          <p>
            “Your vision and ability to put things in perspective have
          ...
          <div class="testimonials__info">
            ...
            />
            <cite class="testimonials__cite">
              <strong>Mr. Aqib Yaseen</strong>
              <span>System Engineer, NEOC</span>
            </cite>
          </div>
        </div>
        ...
        <div class="testimonials__slide">
          <p>
            “One of your strengths is that you almost always deliver projects
          ...
          <div class="testimonials__info">
            ...
            />
            <cite class="testimonials__cite">
              <strong>Mr. Zubair Saleem</strong>
              <span>Team Lead, MCP</span>
            </cite>
          </div>
        </div>
      ...
      <!-- Right Arrow -->
      <button class="arrow arrow--right" aria-label="Next testimonial">&rarr;</button>
    </div>
  </div>
</section>
