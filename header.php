...
<head>
    ...
    <!-- <link href="testimonials_style.css" rel="stylesheet"> -->
...
<body>
   <!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="padding-top: 1.5em;padding-down:1.5em;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#work-experience">Work</a>
                </li>
                <li class="nav-item">
